            ...
            <div className={styles.container}>
                <div className={styles.topSection}>
                    ...
                    <div className={styles.contactCol}>
                        ...
                        <a href="tel:+917448421134" className={styles.contactButton}>
                            <span className={styles.contactLabel}>Phone:</span> +91 74484 21134
                        </a>
                        <a href="mailto:mrcoachofficial@gmail.com" className={styles.contactButton}>
                            <span className={styles.contactLabel}>Email:</span> mrcoachofficial@gmail.com
                        </a>
                    </div>

                    <div className={styles.socialCol}>
                        <a href="https://www.facebook.com/people/MrCoach-J/61554733148919/" target="_blank" rel="noopener noreferrer" className={`${styles.socialIcon} ${styles.facebookIcon}`} aria-label="Facebook">
                            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="currentColor">
                                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                            </svg>
                        </a>
                        <a href="https://www.instagram.com/mrcoachapp/" target="_blank" rel="noopener noreferrer" className={`${styles.socialIcon} ${styles.instagramIcon}`} aria-label="Instagram">
                            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <a href="https://api.whatsapp.com/send/?phone=%2B917448421134&text&type=phone_number&app_absent=0" target="_blank" rel="noopener noreferrer" className={`${styles.socialIcon} ${styles.whatsappIcon}`} aria-label="WhatsApp">
                            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="currentColor">
