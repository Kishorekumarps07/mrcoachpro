    ...
    <main className={styles.main}>
      ...
      <div className={styles.container}>
            ...
            <div className={styles.screen}>
              ...
              <div className={styles.appPadding}>
                <div className={styles.appHeader}>
                  <ArrowRight className={styles.backArrow} size={18} />
                </div>
                ...
                <div className={styles.featureGrid}>
                  <div className={styles.featureItem}>
                    ...
                    <span className={styles.featureDesc}>Personalized Plans</span>
                  </div>
                  <div className={styles.featureItem}>
                    ...
                    <span className={styles.featureDesc}>Custom Meal Plans</span>
                  </div>
                  <div className={styles.featureItem}>
                    ...
                    <span className={styles.featureDesc}>Track & Improve</span>
                  </div>
                </div>
          ...
          <div className={styles.storeButtons}>
            ...
            >
              <div className={styles.storeIcon}>
                <svg viewBox="30 336.7 447 430.3" width="24" height="24">
        ...
        <footer className={styles.trustBadges}>
          ...
          <div className={styles.badgeSeparator} />
          <div className={styles.badge}>
            <CheckCircle size={18} className={styles.badgeIcon} />
